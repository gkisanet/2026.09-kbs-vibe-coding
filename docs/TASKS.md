...
## ✅ Done (완료)
- [x] **`2.,API_TEST` ➔ `2.,AI_APP` 폴더 명칭 변경 및 대문(`README.md`) 2·3단계 목적/비교 설명 보강** (2026-08-16)
  - 📚 **학습 목표**: 3-Tier 아키텍처 이해와 AI Agent 대화 요약 확장(v1➔v2), 독립 웹앱과 브라우저 제어 크롬 확장앱 간의 차이점 명시로 수강생 학습 로드맵 완성
- [x] **`1.교육자료/0-3. 나만의_AI_학습위키_확장가이드.md` 작성 및 대문(`README.md`) 연결** (2026-08-16)
  - 📚 **학습 목표**: 수강생이 어려운 개념을 AI에게 요청하여 `wiki/` 폴더에 자기주도적으로 나만의 백과사전을 구축하고 상호 연결하는 프롬프트 및 프로세스 가이드 확립
